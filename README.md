...
Here I used arcjet but whenever i allow it to be used like uncommenting it in the app.js it automatically assumes all requests are bot requests

I have to fix the above
